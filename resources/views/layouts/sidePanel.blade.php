		...
		<div class="media-group">
			...
			<a href="javascript:void(0)" class="media-group-item">
				<div class="media">
					<div class="media-left">
						<div class="avatar avatar-xs avatar-circle">
							<img src="{{ asset('/bower_components/infinity_admin/assets/images/206.jpg') }}" alt="">
							<i class="status status-online"></i>
						</div>
					</div>
					<div class="media-body">
			...
			<a href="javascript:void(0)" class="media-group-item">
				<div class="media">
					<div class="media-left">
						<div class="avatar avatar-xs avatar-circle">
							<img src="{{ asset('/bower_components/infinity_admin/assets/images/208.jpg') }}" alt="">
							<i class="status status-away"></i>
						</div>
					</div>
					<div class="media-body">
			...
			<a href="javascript:void(0)" class="media-group-item">
				<div class="media">
					<div class="media-left">
						<div class="avatar avatar-xs avatar-circle">
							<img src="{{ asset('/bower_components/infinity_admin/assets/images/209.jpg') }}" alt="">
							<i class="status status-away"></i>
						</div>
					</div>
					<div class="media-body">
			...
			<a href="javascript:void(0)" class="media-group-item">
				<div class="media">
					<div class="media-left">
						<div class="avatar avatar-xs avatar-circle">
							<img src="{{ asset('/bower_components/infinity_admin/assets/images/219.jpg') }}" alt="">
							<i class="status status-away"></i>
						</div>
					</div>
					<div class="media-body">
			...
			<a href="javascript:void(0)" class="media-group-item">
				<div class="media">
					<div class="media-left">
						<div class="avatar avatar-xs avatar-circle">
							<img src="{{ asset('/bower_components/infinity_admin/assets/images/210.jpg') }}" alt="">
			...
			<a href="javascript:void(0)" class="media-group-item">
				<div class="media">
					<div class="media-left">
						<div class="avatar avatar-xs avatar-circle">
							<img src="{{ asset('/bower_components/infinity_admin/assets/images/212.jpg') }}" alt="">
							<i class="status status-offline"></i>
						</div>
					</div>
					<div class="media-body">
